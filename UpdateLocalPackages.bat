...
xcopy %src%cadmus.seed\1.0.8\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.parts\2.2.9\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.seed.parts\1.0.8\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.philology.parts\2.2.11\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.seed.philology.parts\1.0.8\*.nupkg .\local-packages\ /y
