...
xcopy %src%cadmus.index\1.0.2\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.index.sql\1.0.2\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.mongo\2.2.41\*.nupkg .\local-packages\ /y

xcopy %src%cadmus.parts\2.2.39\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.philology.parts\2.2.39\*.nupkg .\local-packages\ /y

xcopy %src%cadmus.seed\1.0.34\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.seed.parts\1.0.39\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.seed.philology.parts\1.0.36\*.nupkg .\local-packages\ /y

xcopy %src%cadmus.archive.parts\2.2.32\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.lexicon.parts\2.2.33\*.nupkg .\local-packages\ /y
pause
