...
xcopy %src%cadmus.philology.parts\2.3.1\*.nupkg .\local-packages\ /y

xcopy %src%cadmus.seed\1.1.2\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.seed.parts\1.1.2\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.seed.philology.parts\1.1.2\*.nupkg .\local-packages\ /y

xcopy %src%cadmus.archive.parts\2.3.1\*.nupkg .\local-packages\ /y
xcopy %src%cadmus.lexicon.parts\2.3.1\*.nupkg .\local-packages\ /y
pause
