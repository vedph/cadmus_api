...
namespace CadmusApi.Controllers
{
    ...
    public sealed class AuthorizationController : Controller
    {
        ...
        /// <summary>
        /// Exchanges the specified username/password pair with an access token.
        /// </summary>
        /// <param name="request">The request.</param>
        /// <returns>connection token</returns>
        ...
        /// </summary>
        /// <returns>User's claims for sub, given_name, family_name, name, email,
        /// email_verified, roles</returns>
